...
export const locations: LocationData[] = [
  ...
  },
  {
    ...
    tier: 3,
    population: "67.000+",
    description: "Bergen op Zoom is een vestingstad in West-Brabant. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Vestingstad", "Carnaval Krabbegansen", "Nabij België"],
    nearbyAreas: ["Roosendaal", "Steenbergen", "Woensdrecht", "Hoogerheide", "Tholen"],
    metaTitle: "SEO Bureau Bergen op Zoom | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Bergen op Zoom. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "48.000+",
    description: "Waalwijk is de schoenenstad van Nederland. Met automatische SEO bereik je klanten in de Langstraat.",
    localFacts: ["Schoen- en lederindustrie", "Nationaal Schoenmuseum", "Logistiek knooppunt"],
    nearbyAreas: ["Tilburg", "Den Bosch", "Kaatsheuvel", "Drunen", "Heusden"],
    metaTitle: "SEO Bureau Waalwijk | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Waalwijk. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "48.000+",
    description: "Middelburg is de hoofdstad van Zeeland. Met automatische SEO bereik je klanten in de hele provincie.",
    localFacts: ["Provinciehoofdstad", "Historische binnenstad", "Veel toerisme"],
    nearbyAreas: ["Vlissingen", "Goes", "Veere", "Domburg", "Arnemuiden"],
    metaTitle: "SEO Bureau Middelburg | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Middelburg. Vanaf €99/mnd."
  },
  {
    slug: "vlissingen",
    name: "Vlissingen",
    ...
    population: "45.000+",
    description: "Vlissingen is een havenstad aan de Westerschelde. Met automatische SEO bereik je toeristen en lokale klanten.",
    localFacts: ["Havenstad", "Badplaats", "Maritieme geschiedenis"],
    nearbyAreas: ["Middelburg", "Goes", "Souburg", "Domburg", "Terneuzen"],
    metaTitle: "SEO Bureau Vlissingen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Vlissingen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "38.000+",
    description: "Goes is een levendig stadje in Zuid-Beveland. Met automatische SEO bereik je klanten in heel Zeeland.",
    localFacts: ["Historische markt", "Centraal in Zeeland", "Veel lokale ondernemers"],
    nearbyAreas: ["Middelburg", "Vlissingen", "Kapelle", "Reimerswaal", "Yerseke"],
    metaTitle: "SEO Bureau Goes | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Goes. Vanaf €99/mnd."
  },
  {
    ...
    population: "55.000+",
    description: "Terneuzen is een havenstad in Zeeuws-Vlaanderen. Met automatische SEO bereik je klanten in de grensregio.",
    localFacts: ["Kanaalzone", "Grens met België", "Chemische industrie"],
    nearbyAreas: ["Hulst", "Axel", "Sas van Gent", "Middelburg", "Gent"],
    metaTitle: "SEO Bureau Terneuzen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Terneuzen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "54.000+",
    description: "Kampen is een Hanzestad aan de IJssel. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Hanzestad", "Theologische Universiteit", "IJsselfront"],
    nearbyAreas: ["Zwolle", "IJsselmuiden", "Elburg", "Dronten", "Hattem"],
    metaTitle: "SEO Bureau Kampen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Kampen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "34.000+",
    description: "Meppel is een handelsstad in Drenthe. Met automatische SEO bereik je klanten in Zuidwest-Drenthe.",
    localFacts: ["Donderdag Meppeldag", "Centraal in Drenthe", "Veel retail"],
    nearbyAreas: ["Zwolle", "Hoogeveen", "Steenwijk", "Staphorst", "De Wijk"],
    metaTitle: "SEO Bureau Meppel | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Meppel. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "108.000+",
    description: "Emmen is de grootste stad van Drenthe. Met automatische SEO bereik je klanten in Zuidoost-Drenthe.",
    localFacts: ["Wildlands Adventure Zoo", "Grootste gemeente Drenthe", "Nabij Duitse grens"],
    nearbyAreas: ["Hoogeveen", "Coevorden", "Klazienaveen", "Borger", "Schoonebeek"],
    metaTitle: "SEO Bureau Emmen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Emmen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "56.000+",
    description: "Hoogeveen is een groeiende gemeente in Drenthe. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Centraal in Drenthe", "Groeiende economie", "Goede bereikbaarheid"],
    nearbyAreas: ["Meppel", "Emmen", "Coevorden", "Beilen", "De Wolden"],
    metaTitle: "SEO Bureau Hoogeveen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Hoogeveen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "69.000+",
    description: "Assen is de hoofdstad van Drenthe. Met automatische SEO bereik je klanten in de hele provincie.",
    localFacts: ["Provinciehoofdstad", "TT Circuit", "Drents Museum"],
    nearbyAreas: ["Groningen", "Meppel", "Hoogeveen", "Beilen", "Roden"],
    metaTitle: "SEO Bureau Assen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Assen. Vanaf €99/mnd."
  },
  {
    slug: "sneek",
    name: "Sneek",
    ...
    tier: 3,
    population: "34.000+",
    description: "Sneek is de waterstad van Friesland. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Sneekweek", "Watersport", "Historische waterpoort"],
    nearbyAreas: ["Leeuwarden", "Heerenveen", "Joure", "Bolsward", "IJlst"],
    metaTitle: "SEO Bureau Sneek | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Sneek. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "50.000+",
    description: "Heerenveen is een sportieve gemeente in Friesland. Met automatische SEO bereik je klanten in Zuidoost-Friesland.",
    localFacts: ["Thialf schaatsstadion", "SC Heerenveen", "Groeiend bedrijventerrein"],
    nearbyAreas: ["Leeuwarden", "Drachten", "Sneek", "Joure", "Wolvega"],
    metaTitle: "SEO Bureau Heerenveen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Heerenveen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "45.000+",
    description: "Drachten is de grootste plaats in Smallingerland. Met automatische SEO bereik je klanten in Zuidoost-Friesland.",
    localFacts: ["Philips-historie", "Verkeersluw experiment", "Groeiende gemeente"],
    nearbyAreas: ["Leeuwarden", "Heerenveen", "Groningen", "Surhuisterveen", "Buitenpost"],
    metaTitle: "SEO Bureau Drachten | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Drachten. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "58.000+",
    description: "Doetinchem is het hart van de Achterhoek. Met automatische SEO bereik je klanten in heel Oost-Gelderland.",
    localFacts: ["Centrum Achterhoek", "De Graafschap", "Goede bereikbaarheid"],
    nearbyAreas: ["Arnhem", "Zutphen", "Winterswijk", "Zevenaar", "Bronckhorst"],
    metaTitle: "SEO Bureau Doetinchem | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Doetinchem. Vanaf €99/mnd."
  },
  {
    slug: "zutphen",
    name: "Zutphen",
    ...
    tier: 3,
    population: "48.000+",
    description: "Zutphen is een historische Hanzestad aan de IJssel. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Hanzestad", "Librije", "Historische binnenstad"],
    nearbyAreas: ["Deventer", "Apeldoorn", "Doetinchem", "Lochem", "Brummen"],
    metaTitle: "SEO Bureau Zutphen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Zutphen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "29.000+",
    description: "Winterswijk is een gemeente in de Achterhoek. Met automatische SEO bereik je klanten in het grensgebied.",
    localFacts: ["Nationaal Landschap", "Grensligging", "Coulissenlandschap"],
    nearbyAreas: ["Doetinchem", "Groenlo", "Aalten", "Bocholt", "Vreden"],
    metaTitle: "SEO Bureau Winterswijk | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Winterswijk. Vanaf €99/mnd."
  },
  {
    slug: "wageningen",
    name: "Wageningen",
    ...
    tier: 3,
    population: "39.000+",
    description: "Wageningen is de universiteitsstad van Food Valley. Met automatische SEO bereik je studenten en professionals.",
    localFacts: ["Wageningen University", "Food Valley", "Stad der Bevrijding"],
    nearbyAreas: ["Arnhem", "Ede", "Rhenen", "Bennekom", "Renkum"],
    metaTitle: "SEO Bureau Wageningen | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Wageningen. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "60.000+",
    description: "Barneveld is een groeiende gemeente op de Veluwe. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Pluimvee-industrie", "Koopmansstad", "Groeiende gemeente"],
    nearbyAreas: ["Amersfoort", "Ede", "Voorthuizen", "Scherpenzeel", "Lunteren"],
    metaTitle: "SEO Bureau Barneveld | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Barneveld. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "47.000+",
    description: "Soest is een groene gemeente nabij Amersfoort. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Nabij Soesterduinen", "Militaire historie", "Veel groen"],
    nearbyAreas: ["Amersfoort", "Baarn", "Soesterberg", "De Bilt", "Hilversum"],
    metaTitle: "SEO Bureau Soest | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Soest. Vanaf €99/mnd."
  },
  {
    slug: "houten",
    name: "Houten",
    ...
    tier: 3,
    population: "50.000+",
    description: "Houten is een jonge gemeente nabij Utrecht. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Fietsstad van Nederland", "Jonge bevolking", "Snel gegroeid"],
    nearbyAreas: ["Utrecht", "Nieuwegein", "Bunnik", "Vianen", "Culemborg"],
    metaTitle: "SEO Bureau Houten | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Houten. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "34.000+",
    description: "IJsselstein is een historisch stadje nabij Utrecht. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Historische binnenstad", "Nabij Nieuwegein", "Goede bereikbaarheid"],
    nearbyAreas: ["Utrecht", "Nieuwegein", "Vianen", "Houten", "Lopik"],
    metaTitle: "SEO Bureau IJsselstein | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in IJsselstein. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "23.000+",
    description: "Lisse is het hart van de Bollenstreek. Met automatische SEO bereik je toeristen en lokale klanten.",
    localFacts: ["Keukenhof", "Bloembollenvelden", "Toerisme"],
    nearbyAreas: ["Noordwijk", "Sassenheim", "Hillegom", "Leiden", "Haarlem"],
    metaTitle: "SEO Bureau Lisse | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Lisse. Vanaf €99/mnd."
  },
  {
    slug: "katwijk",
    name: "Katwijk",
    ...
    tier: 3,
    population: "66.000+",
    description: "Katwijk is een badplaats aan de Zuid-Hollandse kust. Met automatische SEO bereik je toeristen en bewoners.",
    localFacts: ["Badplaats", "ESA nabij", "Hecht gemeenschapsgevoel"],
    nearbyAreas: ["Leiden", "Noordwijk", "Wassenaar", "Rijnsburg", "Valkenburg"],
    metaTitle: "SEO Bureau Katwijk | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Katwijk. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "67.000+",
    description: "Capelle aan den IJssel grenst direct aan Rotterdam. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Nabij Rotterdam", "Veel bedrijvigheid", "Goede bereikbaarheid"],
    nearbyAreas: ["Rotterdam", "Krimpen aan den IJssel", "Nieuwerkerk", "Berkel", "Schiedam"],
    metaTitle: "SEO Bureau Capelle aan den IJssel | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Capelle aan den IJssel. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "47.000+",
    description: "Ridderkerk ligt in het hart van de Drechtsteden. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Drechtsteden", "Goede bereikbaarheid", "Veel mkb"],
    nearbyAreas: ["Rotterdam", "Dordrecht", "Barendrecht", "Zwijndrecht", "Hendrik-Ido-Ambacht"],
    metaTitle: "SEO Bureau Ridderkerk | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Ridderkerk. Vanaf €99/mnd."
  },
  {
    slug: "papendrecht",
    name: "Papendrecht",
    ...
    tier: 3,
    population: "32.000+",
    description: "Papendrecht is een gemeente in de Drechtsteden. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Baggerindustrie", "Drechtsteden", "Nabij Dordrecht"],
    nearbyAreas: ["Dordrecht", "Sliedrecht", "Zwijndrecht", "Gorinchem", "Alblasserdam"],
    metaTitle: "SEO Bureau Papendrecht | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Papendrecht. Vanaf €99/mnd."
  },
  {
    slug: "gorinchem",
    name: "Gorinchem",
    ...
    tier: 3,
    population: "37.000+",
    description: "Gorinchem is een vestingstad aan de Merwede. Met automatische SEO bereik je klanten in de Alblasserwaard.",
    localFacts: ["Vestingstad", "Rivierengebied", "Veel mkb"],
    nearbyAreas: ["Dordrecht", "Leerdam", "Sliedrecht", "Hardinxveld", "Vianen"],
    metaTitle: "SEO Bureau Gorinchem | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Gorinchem. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "79.000+",
    description: "Schiedam is de jeneverstad naast Rotterdam. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Jeneverstad", "Historische molens", "Nabij Rotterdam"],
    nearbyAreas: ["Rotterdam", "Vlaardingen", "Delft", "Den Haag", "Maassluis"],
    metaTitle: "SEO Bureau Schiedam | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Schiedam. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "73.000+",
    description: "Spijkenisse is de grootste stad op Voorne-Putten. Met automatische SEO bereik je klanten op de eilanden.",
    localFacts: ["Boekenstad", "Metro naar Rotterdam", "Groeiende gemeente"],
    nearbyAreas: ["Rotterdam", "Hellevoetsluis", "Brielle", "Hoogvliet", "Barendrecht"],
    metaTitle: "SEO Bureau Spijkenisse | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Spijkenisse. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "58.000+",
    description: "Roermond is een winkelstad in Midden-Limburg. Met automatische SEO bereik je klanten uit heel Limburg.",
    localFacts: ["Designer Outlet", "Maasplassen", "Bisschopsstad"],
    nearbyAreas: ["Venlo", "Weert", "Sittard", "Echt", "Maasbracht"],
    metaTitle: "SEO Bureau Roermond | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Roermond. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "50.000+",
    description: "Weert is een stad in Midden-Limburg. Met automatische SEO bereik je klanten in de grensregio.",
    localFacts: ["Nabij België", "Logistiek knooppunt", "Historische binnenstad"],
    nearbyAreas: ["Roermond", "Eindhoven", "Nederweert", "Cranendonck", "Leudal"],
    metaTitle: "SEO Bureau Weert | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Weert. Vanaf €99/mnd."
  },
  {
    ...
    tier: 3,
    population: "46.000+",
    description: "Kerkrade is een stad in de Parkstad regio. Met automatische SEO bereik je klanten in Zuid-Limburg.",
    localFacts: ["GaiaZOO", "Grensligging met Duitsland", "Mijnverleden"],
    nearbyAreas: ["Heerlen", "Landgraaf", "Brunssum", "Simpelveld", "Aken"],
    metaTitle: "SEO Bureau Kerkrade | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Kerkrade. Vanaf €99/mnd."
  },
  {
    slug: "venray",
    name: "Venray",
    ...
    tier: 3,
    population: "44.000+",
    description: "Venray is een gemeente in Noord-Limburg. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Grootste gemeente Noord-Limburg", "Veel agrarische bedrijvigheid", "Goede bereikbaarheid"],
    nearbyAreas: ["Venlo", "Horst", "Boxmeer", "Gennep", "Deurne"],
    metaTitle: "SEO Bureau Venray | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Venray. Vanaf €99/mnd."
  },
  {
    slug: "steenwijk",
    name: "Steenwijk",
    ...
    tier: 3,
    population: "44.000+",
    description: "Steenwijk is de poort naar de Kop van Overijssel. Met automatische SEO bereik je klanten in Noordwest-Overijssel.",
    localFacts: ["Poort naar Giethoorn", "Vestingstad", "Toerisme"],
    nearbyAreas: ["Zwolle", "Meppel", "Giethoorn", "Vollenhove", "Wolvega"],
    metaTitle: "SEO Bureau Steenwijk | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Steenwijk. Vanaf €99/mnd."
  },
  {
    slug: "raalte",
    name: "Raalte",
    ...
    tier: 3,
    population: "38.000+",
    description: "Raalte is een gemeente in Salland. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Stoppelhaene", "Salland", "Agrarische gemeente"],
    nearbyAreas: ["Zwolle", "Deventer", "Nijverdal", "Heino", "Olst"],
    metaTitle: "SEO Bureau Raalte | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Raalte. Vanaf €99/mnd."
  },
  {
    slug: "nijverdal",
    name: "Nijverdal",
    ...
    tier: 3,
    population: "28.000+",
    description: "Nijverdal is een plaats in gemeente Hellendoorn. Met automatische SEO bereik je klanten in Twente.",
    localFacts: ["Sallandse Heuvelrug", "Recreatie en toerisme", "Centraal in Twente"],
    nearbyAreas: ["Almelo", "Raalte", "Rijssen", "Wierden", "Holten"],
    metaTitle: "SEO Bureau Nijverdal | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Nijverdal. Vanaf €99/mnd."
  },
  {
    slug: "weesp",
    name: "Weesp",
    ...
    tier: 3,
    population: "20.000+",
    description: "Weesp is een vestingstadje nabij Amsterdam. Met automatische SEO bereik je klanten in het Gooi en Amsterdam-Oost.",
    localFacts: ["Vestingstad", "Onderdeel Amsterdam", "Vecht en Spaarne"],
    nearbyAreas: ["Amsterdam", "Muiden", "Naarden", "Bussum", "Diemen"],
    metaTitle: "SEO Bureau Weesp | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Weesp. Vanaf €99/mnd."
  },
  {
    slug: "uithoorn",
    name: "Uithoorn",
    ...
    tier: 3,
    population: "30.000+",
    description: "Uithoorn is een gemeente ten zuiden van Amsterdam. Met automatische SEO bereik je klanten in de regio.",
    localFacts: ["Nabij Schiphol", "Veel mkb", "Groene omgeving"],
    nearbyAreas: ["Amstelveen", "Aalsmeer", "Mijdrecht", "Nieuw-Vennep", "Kudelstaart"],
    metaTitle: "SEO Bureau Uithoorn | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Uithoorn. Vanaf €99/mnd."
  },
  {
    slug: "beverwijk",
    name: "Beverwijk",
    ...
    tier: 3,
    population: "41.000+",
    description: "Beverwijk is bekend om de Bazaar. Met automatische SEO bereik je klanten in de IJmond.",
    localFacts: ["De Bazaar", "IJmond", "Tata Steel nabij"],
    nearbyAreas: ["Haarlem", "Velsen", "Heemskerk", "Zaandam", "Castricum"],
    metaTitle: "SEO Bureau Beverwijk | Lokale Vindbaarheid | KlikKlaarSEO",
    metaDescription: "Automatische SEO voor ondernemers in Beverwijk. Vanaf €99/mnd."
  }
];
