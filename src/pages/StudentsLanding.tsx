              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="bg-accent/5 border border-accent/20 rounded-lg p-4 mt-3">
                  <p className="text-foreground font-medium text-sm">
                    💡 5 klanten per maand klinkt misschien veel, maar dat is nog niet eens 2 per week. Eén goed gesprek per dag met een lokale ondernemer is genoeg. Het product lost een probleem op dat vrijwel elk MKB-bedrijf herkent: "ik word niet gevonden in Google." Je hoeft alleen het gesprek te starten.
                  </p>
                </div>
